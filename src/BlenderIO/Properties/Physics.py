...
class GFSToolsPhysicsBoneProperties(bpy.types.PropertyGroup):
    ...
    unknown_0x00: bpy.props.FloatProperty(name="Sphere Radius", default=0)
    unknown_0x04: bpy.props.FloatProperty(name="Mass", default=0)
    unknown_0x08: bpy.props.FloatProperty(name="Restoring Force", default=0)
    unknown_0x0C: bpy.props.FloatProperty(name="Wind Rate", default=0)
...
class GFSToolsPhysicsLinkProperties(bpy.types.PropertyGroup):
    ...
    mass: bpy.props.FloatProperty(name="Length", default=0)
    unknown_0x04: bpy.props.FloatProperty(name="Angular Limit", default=0)
    radius: bpy.props.FloatProperty(name="Chain Thickness", default=0)
...
class GFSToolsPhysicsProperties(bpy.types.PropertyGroup):
    ...
    unknown_0x00: bpy.props.IntProperty(name="Iterations", default=0, subtype="UNSIGNED")
    unknown_0x04: bpy.props.FloatProperty(name="Deceleration", default=0)
    unknown_0x08: bpy.props.FloatProperty(name="Max Steps", default=0)
    unknown_0x0C: bpy.props.FloatProperty(name="Transfers Tolerance", default=0)
    unknown_0x10: bpy.props.FloatProperty(name="Velocity Tolerance", default=0)
